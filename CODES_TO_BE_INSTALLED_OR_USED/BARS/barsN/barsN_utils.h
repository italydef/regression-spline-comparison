...
void normalize_paired(int, double *, double *, double *, double *);
void normalize_bin(int, double *, double *, double *, double *, double *);
void duplicity(int, double*, double *, int *, int *);
...
void xb(int, int, double *, double *,double *);
double normal_loglik(int, int, double *, double *, double *);
