function  fit = PsplineDR02(x,y,degree,nknots,extrapen,penwt,boundstab, ...
	knots,istd);
%
...
%
%
%	USAGE:  fit = PsplineDR02(x,y,degree,nknots,extrapen,penwt,boundstab,
%		knots);
%
%
%
...
if (nargin < 9 | isempty(istd) == 1) ;
	istd = 1 ;
end ;


if (nargin < 7 | isempty(boundstab) == 1) ;
	boundstab = 0 ;
end ;

if (nargin < 6 | isempty(penwt) == 1) ;
	penwt = logspace(-10,12,100) ;
end ;

if (nargin < 5 | isempty(extrapen) == 1) ;
	extrapen = 0 ;
end ;
