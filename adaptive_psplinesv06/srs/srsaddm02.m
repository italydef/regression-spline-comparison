function fit = srsaddm02(x,y,param);
...
%
%
%   	Last edited: 8/29/2000
%
%	Calls: powerbasis, quantileknots, addbasis
%
%
%	fit = srsaddm02(x,y,param);
%
%
%		INPUT (REQUIRED)
...
%
%		INPUT (OPTIONAL - PUT IN A STRUCTURE)
...
if isfield(param,'z') == 0 ;
	z = [] ;
else ;
	z = param.z ;
end ;

if isfield(param,'type') == 0 ;
	type = 2 ;
else ;
	type = param.type ;
end ;
...
if isfield(param,'nsubknots') == 0 ;
	nsubknots = 3 ;
else ;
	nsubknots = param.nsubknots ;
end ;
...
yhat2 = zeros(n,ngrid) ;
		...
		imin2 = min(  find ((gcv2==min(gcv2))  )) ;
		alpha2(j) = alpha2(j) * 10^(grid(imin2)) ;
		gcv2final = gcv2(imin2) ;
...
alpha3trial = alpha3 ;
	...
	imin3 = min(  find ((gcv3==min(gcv3))  )) ;
	gcv3final = gcv3(imin3) ;
...
gcv1final = gcv1(imin1) ;

if type == 3 ;
fit=struct('yhat1',yhat1,'yhat2',yhat2,'yhat3',yhat3, ...
	'beta1',beta1, 'beta2', beta2, 'beta3', beta3, ...
	'mhat1',mhat1, 'mhat2', mhat2,'mhat3',mhat3, ...
	'gcv1final',gcv1final,'gcv2final',gcv2final,'gcv3final',gcv3final, ...
	'imin1',imin1, ...
	'df1',df1,'df2',df2,'df3',df3, ...
	'sig2hat1',sig2hat1,'sig2hat2',sig2hat2,'sig2hat3',sig2hat3, ...
	'stderror1',stderror1,'stderror2',stderror2, ...
	'var1',var1,'var2',var2, ...
	't1',t1,'t2',t2,'t3',t3, ...
	'p1',p1,'p2',p2,'p3',p3, ...
	'xgrid',xgrid, ...
	'alpha1',alpha1, ...
	'alpha2',alpha2, ...
	'alpha3',alpha3,'penwt',penwt) ;

elseif type == 2 ;
fit=struct('yhat1',yhat1,'yhat2',yhat2, ...
	'beta1',beta1, 'beta2', beta2,  ...
	'mhat1',mhat1, 'mhat2', mhat2, ...
	'gcv1final',gcv1final,'gcv2final',gcv2final, ...
	'imin1',imin1, ...
	'df1',df1,'df2',df2, ...
	'sig2hat1',sig2hat1,'sig2hat2',sig2hat2, ...
	'stderror1',stderror1,'stderror2',stderror2, ...
	'var1',var1,'var2',var2, ...
	't1',t1,'t2',t2, ...
	'p1',p1,'p2',p2, ...
